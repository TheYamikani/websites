        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-9">
            <h1 className="display font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-[88px] leading-[1.0] tracking-[-0.04em] text-paper max-w-5xl">
              Send a note for interviews, network ideas, host expansion, speaking, commissioned reporting, or a story tip.
            </h1>
            <p className="mt-6 font-mono text-[11px] uppercase tracking-[0.2em] text-paper/60 max-w-xl">
              Direct email below · or use the form while the desk is in buildout
            </p>
          </div>
        </div>
      </section>
        ...
        <aside className="md:col-span-5 md:pl-12 md:border-l md:border-paper/15 space-y-14">
          ...
          <div className="rule pt-10">
            ...
            <p className="text-paper/70 text-sm leading-relaxed">
              Every message is read. Responses within 2–3 business days. For time-sensitive press or launch planning, mark the subject line "Urgent."
            </p>
          </div>
        </aside>
      </section>
