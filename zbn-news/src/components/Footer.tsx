      ...
      <div className="container-edge py-14 md:py-20 grid grid-cols-2 md:grid-cols-12 gap-10">
        <div className="col-span-2 md:col-span-5">
          <div className="mb-5 flex items-center gap-4">
            <img
              src="/zbn-logo.png"
              alt={SITE.network}
              className="w-14 h-14 md:w-16 md:h-16 rounded-[18px] object-cover object-center border border-paper/10"
        ...
        <div className="md:col-span-3">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/work" className="text-paper/80 hover:text-signal">Coverage</Link></li>
